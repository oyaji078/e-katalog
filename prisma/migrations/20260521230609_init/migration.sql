...
CREATE TABLE `user` (
    ...
    `retailStatus` ENUM('REGISTERED', 'PENDING_RETAIL', 'RETAIL_ACTIVE', 'RETAIL_REJECTED', 'SUSPENDED') NOT NULL DEFAULT 'REGISTERED',
...
CREATE TABLE `Product` (
    ...
    `publicMarginType` ENUM('PERCENTAGE', 'FIXED_AMOUNT') NOT NULL,
    `publicMarginValue` DECIMAL(10, 2) NOT NULL,
    `retailMarginType` ENUM('PERCENTAGE', 'FIXED_AMOUNT') NOT NULL,
    `retailMarginValue` DECIMAL(10, 2) NOT NULL,
