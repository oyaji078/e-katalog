  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 rounded-xl border border-primary-maroon px-3 py-2 text-sm font-semibold text-primary-maroon"
      >
      ...
      <div className="absolute left-0 mt-2 w-56 rounded-md border border-border-gray bg-white shadow-lg z-20">
        {categories.map((category) => (
          <Link
            ...
            className={`block w-full px-4 py-2 text-sm ${value === category.value ? "bg-primary-maroon/10 text-primary-maroon" : "text-text-muted hover:bg-white/50"}`}
          >
            {category.label}
          </Link>
        ))}
