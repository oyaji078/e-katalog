          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {session ? (
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 z-50 mt-2 w-48 rounded-xl border border-[var(--color-border)] bg-white p-2 shadow-lg">
                    <div className="border-b border-[var(--color-border)] px-3 py-2">
                      ...
                      <p className="text-xs text-[var(--color-text-muted)]">{session.email}</p>
                    </div>
                    <Link
                      href="/"
              ...
              <div className="flex items-center gap-2">
                <Link
                  href="/login"
                  className="hidden px-3 py-2 text-sm transition sm:block"
                ...
                <Link
                  href="/register"
                  className="rounded-lg text-sm transition hover:bg-white/5"
                  style={{
